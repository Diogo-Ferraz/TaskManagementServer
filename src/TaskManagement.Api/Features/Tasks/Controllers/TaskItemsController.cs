...
namespace TaskManagement.Api.Features.Tasks.Controllers
{
    [ApiController]
    ...
    public class TaskItemsController : ControllerBase
    {
        ...
        public TaskItemsController(IMediator mediator, ILogger<TaskItemsController> logger, ICurrentUserService currentUser)
        {
            _mediator = mediator;
            _logger = logger;
